...
Mixture deconvolution utilizes [EuroForMix (EFM)](https://github.com/oyvble/euroformix).  
...
**Allele Frequency Data**: The user must choose which allele frequency data to use:   
  ...
  - EUR 1000G data  
  - SAS 1000G data  
The user may also upload a custom file. See ```Required Files``` page for more details about the format for uploading a custom AF file.  
...
_A quick note on the ATs: both the static and dynamic ATs are applied and the one producing the higher AT will be used in the EFM software._    
