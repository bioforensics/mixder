...
___ 
As of MixDeR version 0.10, a custom SNP set can be utilized, however, the default settings and built-in features will still exist for the Kintelligence assay. Please see the [section on using a custom SNP set](Custom_SNPs.html) for additional information.
