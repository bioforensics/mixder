test_that("Running MixDeR workflow", {
  ...
  expect_error(run_workflow(date, "Sample01a", "", FALSE, "Global - 1000G", "","", refData, outpath, "output", run_mixdeconv=TRUE, unconditioned=TRUE, cond=NULL, "Calculate Metrics", 1, outpath, 0.015, 10, 6000, 0.98, 0.70, 0.98, 0.98, 0.60, 0.60, "", "", filter_missing=FALSE, skipancestry=TRUE, NULL, NULL), "No major/minor contributor IDs provided but calculating metrics for an unconditioned analysis. Please re-run!")
