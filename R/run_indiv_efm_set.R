...
#'
#' @param i Set number
#' @param ids dataframe of relicate data
  ...
  if (isTruthy(evidData)) {
    ...
    if (uncond) {
      ...
      repeat {
        ...
        message(glue("Set {i} unconditioned: Mixture proportion = 0.5 or Allele probability flipping detected - will rerun!"))
    ...
    message(glue("No SNPs called for set {i}. Will skip!"))
  }
  return(final_list)
}
